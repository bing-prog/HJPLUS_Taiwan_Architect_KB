...
> **上層分類可以用中文，但最底層的技能資料夾必須用小寫英文連字號。**

| 層級 | 格式 | 範例 |
|------|------|------|
| 分類 | 繁體中文 | `建築法規/` |
| 子分類 | 繁體中文 | `消防安全/` |
| 技能資料夾 | **小寫英文 + 連字號** | `smoke-exhaust-review/` |

| 狀態 | 範例 |
|------|------|
| ✅ 正確 | `建築法規/消防安全/smoke-exhaust-review/` |
| ❌ 錯誤 | `建築法規/消防安全/排煙設備審查/` |

如果你用中文建立了資料夾，AI 會自動幫你改成英文並告知你已轉換。

> **資料夾名稱必須是英文翻譯，不可使用中文拼音。**
